  ...
  constructor(client) {
    super(client, {
      ...
      args: [
        ...
        {
          key: 'tier',
          prompt: 'What tier is this pokémon? (`0` to remove, `1`, `3`, `4`, `5`, `ex`, `mega`, `mega-legendary`, `unset-ex`, `unset-mega`)',
          type: 'string',
          oneOf: ['0', '1', '3', '4', '5', 'ex', 'mega', 'mega-legendary', 'unset-ex', 'unset-mega']
        }
      ],
      guildOnly: true
    });
